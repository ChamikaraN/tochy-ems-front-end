      ...
      <div className={s.wrap}>
        ...
        <main className={s.content}>
          ...
          <Switch>
            ...
            <PermitedRoute path="/template/viewallbusiness" dispatch={props.dispatch} role={props.profileData.role} exact component={Viewallbusiness} />
            <Route path="/template/employee" exact component={Viewallemployee} />
            <Route path="/template/domain" exact component={ViewDomainList} />
            
            <Route path="/template/viewallemailtemplates" exact component={ViewEmailtemplate} />
            <Route path="/template/viewemail" exact component={EmailListTable} />
            
            <PermitedRoute path="/template/addemailtemplate" dispatch={props.dispatch} role={props.profileData.role} exact component={AddEmailtemplate} />
