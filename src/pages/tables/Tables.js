              ...
              <Widget>
               ...
               <> <div className={s.tableTitle}>
                  ...
                  <button className="btn btn-primary rounded-pill mx-auto logout-btn" type="submit">
                    <span className="ml-1 viewall-btn"><Link to='/template/employee'>View All</Link></span></button>
                    {/*<img src="" alt="Filter option"/>*/}
                  </div>
                </div>
                <div className={s.widgetContentBlock}>
                  {employees && employees.slice(0,4).map(item => (
                    <div key={uuidv4()} className={s.content}>
                    <div className="col-12">
                    <div className="body-3 muted d-none d-md-block ">Reg. Date: {item.createdAt.slice(0,10)}</div>
               ...
               <> <div className={s.tableTitle}>
                  ...
                  <div>
                  <button className="btn btn-primary rounded-pill mx-auto logout-btn" type="submit">
                    <span className="ml-1"><Link to='/template/business'>View All</Link></span></button>
                    {/*<img src="" alt="Filter option"/>*/}
                  </div>
                </div>
                <div className={s.widgetContentBlock}>
                  {business && business.slice(0,4).map(item => (
                    <div key={uuidv4()} className={s.content}>
                      <div className="col-12">
                      <div className="body-3 muted d-none d-md-block col-4">Reg. Date: {item.createdAt.slice(0,10)}</div>
                      <div className="body-2 col-4">Name: {item.name}</div>
                      <div className="body-3 muted d-none d-lg-block col-4">Email: {item.email}</div>
