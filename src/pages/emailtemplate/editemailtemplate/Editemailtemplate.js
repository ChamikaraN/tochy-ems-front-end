    ...
    <div>
      <Modal isOpen={props.show} toggle={props.toggle}>
                      ...
                      <form className="form-valide">
                        <div className="form-group row">
                          ...
                          <div className="col-lg-8">
                            <input
                              ...
                              id="val-username"
                              name="title"
                              value={props.changedField.title}
                              placeholder="Enter a title.."
                              onChange={(e) =>
                                props.setChangedField((prev) => ({
                                  ...prev,
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-lg-8">
                            <input
                              ...
                              id="val-username"
                              name="title"
                              value={props.changedField.emailfrom}
                        ...
                        <div className="form-group row">
                          ...
                          <div className="col-lg-8">
                            <input
                              ...
                              id="val-username"
                              name="title"
                              value={props.changedField.subject}
                        ...
                        <div className="form-group row">
                          ...
                          <input
                              ...
                              checked={props.changedField.publicAccess}
                            />
                          </div>
                        </div>
        ...
        <ModalFooter>
          ...
          {modalType === "edit" && (
            <Button color="primary" onClick={props.editSubmit}>
              Submit
            </Button>
          )}
          {modalType === "add" && (
            <Button color="primary" onClick={props.addSubmit}>
              Add
            </Button>
          )}
        </ModalFooter>
